...
/**
 * IFS Area Request XML To Vertex
 *
 * IMPORTANT !!!
 * Do not place this class inside a package. It should be
 * in the default package.
 */
public class IFSAreaRequestXMLToVertex implements Transformer {
   ...
   public String transform(String sIn) throws IfsException {
      ...
      String sVertexEnvelope = "<VertexEnvelope xsi:schemaLocation=\"" + "urn:vertexinc:o-series:tps:7:0 VertexInc_Envelope.xsd\" " + "xmlns:xsi=" + "\"http://www.w3.org/2001/XMLSchema-instance\"" + " xmlns=\"urn:vertexinc:o-series:tps:7:0\"> \n";
