...
/**
 * I F S Address Validation Request X M L To Avalara
 *
 * IMPORTANT !!!
 * Do not place this class inside a package. It should be
 * in the default package.
 */
public class IFSAddressValidationRequestXMLToAvalara implements Transformer {
   ...
   public String transform(String sIn) throws IfsException {
      ...
      try {
         ...
         sb.append("<ser:Validate>\n");
         sb.append("<ser:ValidateRequest>\n");
         sb.append("<ser:Address>\n");

         NodeList addresses = doc.getElementsByTagName("ADDRESS");
         Node address = addresses.item(0);
         if (address.getNodeType() == Node.ELEMENT_NODE) {
            Element refElement = (Element) address;
            sb.append("<ser:AddressCode>").append(getValueByTagName("ADDRESS_CODE", refElement)).append("</ser:AddressCode>\n");
            sb.append("<ser:Line1>").append(getValueByTagName("LINE1", refElement)).append("</ser:Line1>\n");
            sb.append("<ser:Line2>").append(getValueByTagName("LINE2", refElement)).append("</ser:Line2>\n");
            sb.append("<ser:Line3>").append(getValueByTagName("LINE3", refElement)).append("</ser:Line3>\n");
            sb.append("<ser:City>").append(getValueByTagName("CITY", refElement)).append("</ser:City>\n");
            sb.append("<ser:Region>").append(getValueByTagName("REGION", refElement)).append("</ser:Region>\n");
            sb.append("<ser:PostalCode>").append(getValueByTagName("POSTAL_CODE", refElement)).append("</ser:PostalCode>\n");
            sb.append("<ser:Country>").append(getValueByTagName("COUNTRY", refElement)).append("</ser:Country>\n");
            sb.append("<ser:TaxRegionId>").append("1").append("</ser:TaxRegionId>\n");
         }
