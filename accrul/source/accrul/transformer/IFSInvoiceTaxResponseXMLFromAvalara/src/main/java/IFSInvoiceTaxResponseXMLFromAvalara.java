...
/**
 * I F S Invoice Tax Response X M L From Avalara
 *
 * IMPORTANT !!!
 * Do not place this class inside a package. It should be
 * in the default package.
 */
public class IFSInvoiceTaxResponseXMLFromAvalara implements Transformer {
    ...
    try
    {
      ...
      for (int i = 0; i < msgLinesa.getLength(); i++)
      {
        ...
        if (msgLinea.getNodeType() == 1) {
          ...
          sb.append("<SUMMARY>" + getValue(refElementa, "Summary", i) + "</SUMMARY>\n");
          sb.append("<DETAILS>" + getValue(refElementa, "Details", i) + "</DETAILS>\n");
