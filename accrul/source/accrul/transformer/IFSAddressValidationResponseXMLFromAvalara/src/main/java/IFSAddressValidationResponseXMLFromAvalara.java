...
/**
 * I F S Address Validation Response X M L From Avalara
 *
 * IMPORTANT !!!
 * Do not place this class inside a package. It should be
 * in the default package.
 */
public class IFSAddressValidationResponseXMLFromAvalara implements Transformer {
   ...
   public String transform(String sIn) throws IfsException {
    ...
    try
    {
        ...
        nodes = doc.getElementsByTagName("ValidateResult");
        ...
        if(nodes.getLength() > 0){
	        ...
	        if (node.getNodeType() == Node.ELEMENT_NODE) {
			    refElement = (Element)node;
			    sb.append("<MESSAGE>").append(getValueByTagName("Details", refElement)).append("</MESSAGE>\n");
			    sb.append("<REFERS_TO>").append(getValueByTagName("RefersTo", refElement)).append("</REFERS_TO>\n");
			    sb.append("<SEVERITY>").append(getValueByTagName("Severity", refElement)).append("</SEVERITY>\n");			    
	        }
        }
