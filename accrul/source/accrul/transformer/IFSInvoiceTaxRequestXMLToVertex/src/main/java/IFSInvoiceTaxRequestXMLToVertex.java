...
/**
 * IFS Invoice Tax Request XML To Vertex
 *
 * IMPORTANT !!!
 * Do not place this class inside a package. It should be
 * in the default package.
 */
public class IFSInvoiceTaxRequestXMLToVertex implements Transformer {
   ...
   public String transform(String sIn) throws IfsException {
      ...
      try {
         ...
         sVertexEnvelope = "<VertexEnvelope xmlns=\"urn:vertexinc:o-series:tps:" + versionId + ":0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"urn:vertexinc:o-series:tps:" + versionId + ":0 VertexInc_Envelope.xsd\">\n";
         ...
         NodeList msgLines = doc.getElementsByTagName("INVOICE_REQUEST");
         sOut.append("<InvoiceRequest ");
         for (int i = 0; i < msgLines.getLength(); i++) {
            ...
            if (msgLine.getNodeType() == Node.ELEMENT_NODE) {
               ...
               if (getValueByTagName("DOCUMENT_NUMBER", refElement).length() > 0) {
                  sOut.append("documentDate=\"").append(getValueByTagName("DOCUMENT_DATE", refElement)).append("\" documentNumber=\"").append(getValueByTagName("DOCUMENT_NUMBER", refElement)).append("\" transactionType=\"").append(getValueByTagName("TRANSACTION_TYPE", refElement)).append("\">\n");
               } else {
