...
IS  
   ...
   SELECT   rowid, TO_CHAR(rowversion,'YYYYMMDDHH24MISS')       
      ...
      WHERE tool_specification_code = mx_unique_key_;
BEGIN
   OPEN  get_key;
...
IS
   ...
   tool_specification_code_   av_tool_specification_tab.tool_specification_code%TYPE;
BEGIN
   local_attr_              := attr_;
   tool_specification_code_ := Client_SYS.Get_Item_Value('TOOL_SPECIFICATION_CODE', local_attr_); 
   
   IF Check_Exist___(tool_specification_code_) THEN
